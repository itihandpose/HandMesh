...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--exp_name', type=str, default='mobrecon')
        ...
        parser.add_argument('--out_channels', nargs='+', default=[32, 64, 128, 256], type=int)
        ...
        parser.add_argument('--model', type=str, default='mobrecon')
        parser.add_argument('--backbone', type=str, default='DenseStack')
        ...
        parser.add_argument('--resume', type=str, default='mobrecon_densestack_dsconv.pt')
